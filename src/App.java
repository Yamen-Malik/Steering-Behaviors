...
public class App {
        ...
        while (true) {
            ...
            if (delta >= 1) {
                ...
                for (Vehicle v : vehicles) {
                    // If the vehilce reached it's target then reset the target Vehcile
                    if (v.target != null
                            && (v.behavior == Vehicle.Behavior.Seek || v.behavior == Vehicle.Behavior.Pursue)
                            && Vehicle.CheckCollision(v, v.target)) {
    ...
    public static void Start(Vehicle[] vehicles) {
        ...
        // Randomize the position and velocity of the vehicles
        for (Vehicle v : vehicles) {
